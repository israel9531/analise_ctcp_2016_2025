...
with col_in1:
    csv_2016_path = st.text_input(
        ...
        "https://raw.githubusercontent.com/israel9531/analise_ctcp_2016_2025/refs/heads/main/data/dados_ctcp_2016.csv"
    )
with col_in2:
    csv_2025_path = st.text_input(
        "CSV 2025 (caminho opcional)",
        "https://raw.githubusercontent.com/israel9531/analise_ctcp_2016_2025/refs/heads/main/data/dados_ctcp_2025.csv"
    )
